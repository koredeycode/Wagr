  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-between whitespace-nowrap border-b border-border px-6 md:px-10 py-4">
      ...
      <div className="flex items-center gap-4">
        {/* <Link
                    href="/sign-in"
                    className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-transparent border border-transparent hover:border-primary text-sm font-bold leading-normal tracking-[0.015em] transition-all"
                  >
